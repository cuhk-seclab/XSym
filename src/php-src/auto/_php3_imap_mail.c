#include "stdio.h"
#include "phli.h"
int _php3_imap_mail(char*,char*,char*,char*,char*,char*,char*);
int main(int argc, char* argv[]) {
char *result_dir="/data/phli/results/_php3_imap_mail/";
...
int result;
result=_php3_imap_mail(arg_0,arg_1,arg_2,arg_3,arg_4,arg_5,arg_6);
}