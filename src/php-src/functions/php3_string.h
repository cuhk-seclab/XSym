...
extern void php3_str_replace(pval *, pval *, pval*, pval*);
...
extern void php3_substr(pval*, pval*, pval*, pval*);
extern void php3_pos(pval*, pval*, pval*, pval*);
...
//extern void php3_ord(INTERNAL_FUNCTION_PARAMETERS);
extern void php3_ord1(INTERNAL_FUNCTION_PARAMETERS);
