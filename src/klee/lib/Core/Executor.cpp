...
void Executor::addConstraint(ExecutionState &state, ref<Expr> condition) {
        ...
        //ExprPPrinter::printOne(info, "phli test", result);
        //result.print(llvm::errs())
        //std::cout << Instruction::Ret << Instruction::Ret=="1" ;
        std::cout << " phli added in addconsraint :1108 \n";
...
void Executor::executeInstruction(ExecutionState &state, KInstruction *ki) {// phli
  Instruction *i = ki->inst;
  ...
  case Instruction::Ret: {
    ...
    if (!isVoidReturn) {
        ...
        std::string TestStr;
        llvm::raw_string_ostream info(TestStr);
        ExprPPrinter::printSingleExpr(info, result);
        std::cout << info.str() << "\n";
        ...
        //result.print(llvm::errs())
        //std::cout << Instruction::Ret << Instruction::Ret=="1" ;
        std::cout << " phli added in Ret:1608 \n";
    }
  ...
  case Instruction::Br: {
    ...
    if (bi->isUnconditional()) {
      ...
      cond = optimizer.optimizeExpr(cond, false);
        ...
        std::string TestStr;
        llvm::raw_string_ostream info(TestStr);
        ExprPPrinter::printSingleExpr(info, cond);
        std::cout << info.str() << "\n";

        //ExprPPrinter::printOne(info, "phli test", result);
        //result.print(llvm::errs())
        //std::cout << Instruction::Ret << Instruction::Ret=="1" ;
        std::cout << " phli added in Cond:1678 \n";
